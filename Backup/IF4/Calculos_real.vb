...
'messagebox.show("b")
If ((ax_maquina.Equals("SF1")) Or (ax_maquina.Equals("SF2"))) Then
porc_anchopapelusado = 1
''messagebox.show("ba")
Else

'messagebox.show("ancho rollo usado:" + cstr(anchorollousado) + " / ancho util : " + cstr(ancho_util))
porc_anchopapelusado = v_prod / ancho_util
''messagebox.show("bb")
End If
'messagebox.show("c")
'messagebox.show("indice:" + cstr(indice) + " porc  Y :" + cstr(porc_anchopapelusado))
