...
Public Shared Function clean_resumen() As Integer
        ...
        Try
            ...
            Dim mystring2 As String = "delete  from resumen_t"
  ...
  Public Shared Function integra_resumen(ByVal indice, ByVal ci, ByVal empalmador, ByVal rollo, ByVal fecha_consumo, ByVal consecutivo, ByVal correccion)
       ...
       Dim sal As Double
        Dim fecha_consu As String = Format(fecha_consumo, "dd/MM/yyyy HH:mm:ss")
        ...
        Try
           ...
           conn2.Open()
            cmd2.CommandText = "INSERT INTO resumen_t  VALUES " & _
...
'MessageBox.Show("fin de  revision 5  de cf a ck")
    ...
    Public Shared Function update_cj(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET kginicialesduplic =  " + CStr(val) + "    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_ck(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET ci_error2 =  '" + CStr(val) + "'    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_cf(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET ci_dif_ent_sal =  '" + CStr(val) + "'    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_cg(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET ultimo_emp_re =  '" + CStr(val) + "'    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
...
Public Shared Function update_ch(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET cambio_empal_sinval =  " + CStr(val) + "    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
...
Public Shared Function update_ci(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET ci_error_ =  '" + CStr(val) + "'    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_ca(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET tipo_papel_coincide =  '" + CStr(val) + "'    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_ce(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET diferenciaenultimokgsalidaafecta =  '" + CStr(val) + "'    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_bz(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET diferenci_ent_sal =  " + CStr(val) + "    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_by(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET ultimokgsalida =  '" + CStr(val) + "'    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_cc(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET kginicialescuenta =  " + CStr(val) + "    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_cd(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET kgfinalescuenta =  " + CStr(val) + "    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_bs(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET respuesta =  '" + CStr(val) + "'    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_bt(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET cisinerror =  '" + CStr(val) + "'    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_bu(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET faltaderollo =  '" + CStr(val) + "'    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_bw(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET rolloescaneadoynousado =  '" + CStr(val) + "'    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_bx(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET parte_lote =  '" + CStr(val) + "'    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_bn(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET kginicialescuentacum =" + CStr(val) + "  WHERE  indice = " + CStr(indice) + " "
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_bo(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET =" + CStr(val) + "  WHERE  indice = " + CStr(indice) + " "
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_bp(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET entradas_salidas =" + CStr(val) + "  WHERE  indice = " + CStr(indice) + " "
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_bq(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET tienekgsalida = '" + CStr(val) + "'  WHERE  indice = " + CStr(indice) + " "
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_br(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET ent_sal_kgsalida ='" + CStr(val) + "'  WHERE  indice = " + CStr(indice) + " "
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_bm(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET cicapturaduplicada ='" + CStr(val) + "'  WHERE  indice = " + CStr(indice) + " "
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
...
End Function
    ...
    Public Shared Function update_bl(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET capturasduplicadas =  " + CStr(val) + "    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
    ...
    Public Shared Function update_bi(ByVal indice, ByVal val)
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "UPDATE  resumen_t SET ancho_papel_coincide =  '" + CStr(val) + "'    WHERE  indice = " + CStr(indice) + ""
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
...
''// Analizar registro de  muestra
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = " Select  * from resumen_t "
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
            Dim conta As Integer = 0
...
'MessageBox.Show("1.4")
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "select * FROM muestras_t  where     Fecha_consumo < '" + CStr(fecha_consumo) + "'    order by Fecha_consumo asc"
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
'MessageBox.Show("1.5")
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
...
Dim parte_vs, rollo_vs, inicialescorr_vs
 Dim suma = 0, entry = 0
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "select * FROM muestras_t where MrowID <= " + CStr(indice) + " order by Fecha_consumo asc"
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
...
Return entry
    ...
    Public Shared Function get_BL(ByVal parte, ByVal lote, ByVal CI) As Integer
        ...
        Try
            ...
            Dim conn2 As OdbcConnection = New OdbcConnection()
            conn2.ConnectionString = cs
            Dim mystring2 As String = "select  count(parte) as entradas  from muestras_t where  parte= '" + CStr(parte) + "' and rollo='" + CStr(lote) + "' and  CI='" + CStr(CI) + "'"
            Dim cmd2 As OdbcCommand = New OdbcCommand(mystring2, conn2)
            conn2.Open()
            Dim reader2 As OdbcDataReader = cmd2.ExecuteReader()
            Dim conta As Integer = 0
